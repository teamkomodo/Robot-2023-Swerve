/*--------------------------------------------------------*/
/*| SimIO_patched is a modification to the original NavX  |*/
...
class SimIO_patched implements IIOProvider {  
    ...
    public SimIO_patched(byte update_rate_hz, IIOCompleteNotification notify_sink, SimDevice sim_device) {      
        ...
        if (sim_device != null) {
            ...
            simConnected            = sim_device.createBoolean("Connected", Direction.kOutput, true); 
            
            // Doubles
            
            simRate                 = sim_device.createDouble("Rate", Direction.kOutput, 0.0f);
            simYaw                  = sim_device.createDouble("Yaw", Direction.kOutput, 0.0f);
            simPitch                = sim_device.createDouble("Pitch", Direction.kOutput, 0.0f);
            simRoll                 = sim_device.createDouble("Roll", Direction.kOutput, 0.0f);     
            
            simCompassHeading       = sim_device.createDouble("CompassHeading",Direction.kOutput, 0.0f);
            simFusedHeading         = sim_device.createDouble("FusedHeading", Direction.kOutput, 0.0f);     

            simLinearWorldAccelX    = sim_device.createDouble("LinearWorldAccelX", Direction.kOutput, 0.0f);                                
            simLinearWorldAccelY    = sim_device.createDouble("LinearWorldAccelY", Direction.kOutput, 0.0f); 
            simLinearWorldAccelZ    = sim_device.createDouble("LinearWorldAccelZ", Direction.kOutput, 0.0f);   
