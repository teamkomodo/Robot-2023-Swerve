 ...
 *
 * <p>
 * {@link SwerveDrivePoseEstimatorImpl#update} should be called every robot
 * loop.
 *
 * <p>
 * {@link SwerveDrivePoseEstimatorImpl#addVisionMeasurement} can be called as
 * infrequently as you
 * want; if you never call it, then this class will behave as regular encoder
 * odometry.
 */
public class SwerveDrivePoseEstimatorImpl {
    private final SwerveDriveKinematics m_kinematics;
    private final SwerveDriveOdometryImpl m_odometry;

    public SwerveDriveOdometryImpl getOdometry() {
        return m_odometry;
    }
     ...
     */
    public SwerveDrivePoseEstimatorImpl(
    ...
    public SwerveDrivePoseEstimatorImpl(
        ...
        m_odometry = new SwerveDriveOdometryImpl(kinematics, gyroAngle, modulePositions, initialPoseMeters);
     ...
     * calling {@link
     * SwerveDrivePoseEstimatorImpl#update} every loop.
     *
     * <p>
     ...
     *                              SwerveDrivePoseEstimatorImpl#updateWithTime(double,Rotation2d,SwerveModulePosition[])}
     *                              then you
     ...
     * SwerveDrivePoseEstimatorImpl#setVisionMeasurementStdDevs(Matrix)} or this
     * method.
     *
    ...
    public Pose2d updateWithTime(
        ...
        for (int i = 0; i < m_numModules; i++) {
            internalModulePositions[i] = new SwerveModulePosition(modulePositions[i].distanceMeters,
    ...
    private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
         ...
         *
         * @param pose           The pose observed given the current sensor inputs and
         *                       the previous pose.
        ...
        public InterpolationRecord interpolate(InterpolationRecord endValue, double t) {
            if (t < 0) {
                ...
                for (int i = 0; i < m_numModules; i++) {
                    double ds = MathUtil.interpolate(
